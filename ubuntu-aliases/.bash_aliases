...
alias gcm='function __gcm() { eval "git commit -m \"$*\""; unset -f __gcm; }; __gcm'
alias gaf='function __gaf() { eval "git add $*"; unset -f __gaf; }; __gaf'
alias gdfile='function __gdfile() { eval "git diff $*"; unset -f __gdfile; }; __gdfile'
